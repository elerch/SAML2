...
{
    /// <summary>
    /// Configuration options for <see cref="SamlAuthenticationMiddleware"/>
    /// </summary>
    public class SamlAuthenticationOptions : AuthenticationOptions
    {
        ...
        /// </summary>
        public SamlAuthenticationOptions()
            : this(SamlAuthenticationDefaults.AuthenticationType)
        {
        }
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly", MessageId = "Saml", Justification = "Not a LOC field")]
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "Microsoft.Owin.Security.Saml.SamlAuthenticationOptions.set_Caption(System.String)", Justification = "Not a LOC field")]
        public SamlAuthenticationOptions(string authenticationType)
            : base(authenticationType)
        {
            AuthenticationMode = Security.AuthenticationMode.Active;
            Caption = SamlAuthenticationDefaults.Caption;
